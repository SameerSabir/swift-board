  ...
  return (
    ...
    >
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14">
        ...
        <div
          className={`flex flex-col lg:flex-row gap-5 transition-all duration-700 delay-150 ${
            ...
            <div className="rounded-3xl bg-[#f5f0ff] p-7 flex flex-col h-full">
              ...
              <div className="text-center mb-1">
                <div className="flex items-baseline justify-center gap-2">
                  <span className="text-6xl font-extrabold text-secondary leading-none">
                    $99
                  </span>
                </div>
            ...
            <div className="rounded-3xl border border-neutral-100 bg-white p-7 shadow-sm">
              ...
              <ul className="space-y-3">
                {PRICING_FEATURES.map((feature) => (
                  ...
                  >
                    <span className="text-primary font-bold mt-px leading-snug">
                      •
                    </span>
                    <span>
